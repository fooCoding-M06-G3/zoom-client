...
export default function PostItemComponent() {
  ...
  const handleImageChange = event => {
    setImages({
      url: [...images.url, URL.createObjectURL(event.target.files[0])],
      images: [...images.images, event.target.files[0]]
    });
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <InputLabel
            style={{ textAlign: "left", marginTop: 20, marginLeft: 10 }}
          >
            Pictures
          </InputLabel>
